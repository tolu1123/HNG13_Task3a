      ...
      <div className="">
        ...
        <div className="flex flex-col gap-2">
          <p className="flex justify-between">
            ...
            <span className="inline-block text-[1.125rem]/[100%] uppercase font-bold">${total}</span>
          </p>
          ...
          <p className="flex justify-between">
            ...
            <span className="inline-block text-[1.125rem]/[100%] uppercase font-bold">$1,089</span>
          </p>
        </div>
        ...
        <div className="mt-6 mb-8">
          <p className="flex justify-between">
            ...
            <span className="inline-block text-[1.125rem]/[100%] text-orange font-bold uppercase">${total + 50 + 5396}</span>
          </p>
        </div>
      </div>
    </div>
